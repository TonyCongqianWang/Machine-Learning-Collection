...
def get_dataset_cvat(is_train, args):
    dataset, num_classes = get_cvat(        
        int(args.data_path),
        is_train,
...
def get_transform(is_train, args):
    if is_train:
        return presets.DetectionPresetTrain(
            data_augmentation=args.data_augmentation, backend=args.backend,
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument(
        "--enable-hflip",
        dest="enable_hflip",
        help="Enables hflip, disabled by default",
        action="store_true",
    )
    parser.add_argument(
